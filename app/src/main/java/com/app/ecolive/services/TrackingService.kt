...
import com.app.ecolive.taximodule.TrackingUtility
import com.app.ecolive.utils.AppConstant
import com.app.ecolive.utils.AppConstant.ACTION_PAUSE_SERVICE
import com.app.ecolive.utils.AppConstant.ACTION_SHOW_TRACKING_FRAGMENT
import com.app.ecolive.utils.AppConstant.ACTION_START_OR_RESUME_SERVICE
import com.app.ecolive.utils.AppConstant.ACTION_STOP_SERVICE
import com.app.ecolive.utils.AppConstant.FASTEST_LOCATION_UPDATE_INTERVAL
import com.app.ecolive.utils.AppConstant.LOCATION_UPDATE_INTERVAL
import com.app.ecolive.utils.AppConstant.NOTIFICATION_CHANNEL_ID
import com.app.ecolive.utils.AppConstant.NOTIFICATION_CHANNEL_NAME
import com.app.ecolive.utils.AppConstant.NOTIFICATION_ID
...
//                        val putData = "{ ${location.latitude} , ${location.longitude} }"
                        Timber.d("add_Location $jsonObject")
                        jsonArray.put(jsonObject)

                        if (pathPoints.value!!.isNotEmpty() && pathPoints.value!!.last().isNotEmpty()) {
                            Log.d(
                                "TAG",
                                "onLsdfasdfocationResult: ${pathPoints.value!!.last().last()} "
                            )
                            bearing = getBearing(
                                begin = pathPoints.value!!.last().last(),
    ...
    private fun startTimer() {
        ...
        CoroutineScope(Dispatchers.Main).launch {
            while (isTracking.value!!) {
                ...
                delay(AppConstant.TIMER_UPDATE_INTERVAL)
            }
            timeRun += lapTime
        }
    }
...
//    private fun addPoint(location: String?) {
//        location?.let {
//            jsonArray.value?.apply {
//                last().add(location)
//                pathPoints.postValue(this)
//            }
//        }
...
//
    ...
    //you can remove this code when apply dagger hilt
    private fun getMainActivityPendingIntent() = PendingIntent.getActivity(
        this, 0,
        Intent(this, UserHomePageNavigationActivity::class.java).also {
...
//        if(!serviceKilled) {
//            curNotification = baseNotificationBuilder
//                .addAction(R.drawable.ic_video_play_lib, notificationActionText, pendingIntent)
