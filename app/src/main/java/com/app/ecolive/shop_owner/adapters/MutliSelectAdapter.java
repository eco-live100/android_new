...
import com.app.ecolive.localmodel.MultiSelectModel;
import com.app.ecolive.utils.MultiSelectDialog;
...
public class MutliSelectAdapter extends RecyclerView.Adapter<MutliSelectAdapter.MultiSelectDialogViewHolder> {
    ...
    private void setHighlightedText(int position, TextView textview) {
        ...
        ColorStateList highlightedColor = new ColorStateList(new int[][]{new int[]{}}, new int[]{ContextCompat.getColor(mContext, R.color.purple_700)});
