...
class VisitShopProductListAdapter(var context: Context, var dataList: ArrayList<SimilarProductListModel>, var onClickListener: ClickListener) :
    RecyclerView.Adapter<VisitShopProductListAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.binding.rowProductPrecription.visibility =View.GONE
