...
import com.app.ecolive.databinding.ActivityReviewCustomerToRiderBinding
import com.app.ecolive.databinding.ActivityReviewCustomerToShopBinding
import com.app.ecolive.localmodel.ReviewRiderToCustomerModel
import com.app.ecolive.review_module.adapters.ReviewCustomerToShopListAdapter
import com.app.ecolive.review_module.adapters.ReviewRiderToCustomerListAdapter
import com.app.ecolive.utils.Utils

class ReviewCustomerToRiderActivity : AppCompatActivity() {
    private lateinit var binding: ActivityReviewCustomerToRiderBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = DataBindingUtil.setContentView(this, R.layout.activity_review_customer_to_rider)
        statusBarColor()
        reviewList()
    }
    private fun statusBarColor() {
        binding.include3.toolbarTitle.text="Reviews"
