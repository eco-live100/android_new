...
class ReviewRiderToCustomerListAdapter(var context: Context, var dataList: ArrayList<ReviewRiderToCustomerModel>) :
    RecyclerView.Adapter<ReviewRiderToCustomerListAdapter.ViewHolder>() {
