...
class ReviewCustomerToShopActivity : AppCompatActivity() {
    private lateinit var binding: ActivityReviewCustomerToShopBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = DataBindingUtil.setContentView(this, R.layout.activity_review_customer_to_shop)
    ...
    private fun reviewList() {
        ...
        val adapter = ReviewCustomerToShopListAdapter(this, dataList)
